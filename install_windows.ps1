# Script de Instalação Automática - Frota 2.0 (PostgreSQL Edition)
...
# 3. Instalar PostgreSQL via Winget
...
# 6. Criar arquivo de inicialização automática
...
@echo off
cd /d "$projectPath"
echo Iniciando Sistema Frota 2.0 (PostgreSQL)...
npm start
"@ 
...
Write-Host "IMPORTANTE: Certifique-se de configurar o DATABASE_URL no arquivo server/.env" -ForegroundColor Yellow
